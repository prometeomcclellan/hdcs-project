...
if ( $detect->isMobile() ) {
  ...
  echo "<div id='dWrapper' class='wrapper' style='width: 80%;float:right;'>";
    ...
    <div class="container">
        <header>
          <h1 class="mt-4"><b>Gestión tipo de disco</b></h1>
            <ol class="breadcrumb mb-4">
              <li class="breadcrumb-item"><a href="../../inicio/dashboard.php">Dashboard</a></li>
              <li class="breadcrumb-item active">Tipo disco</li>
            </ol>
        </header> 
    </div>    
  ...
  background : #1a3c8a;
    ...
    <div class="container caja">
        <div class="row">
            ...
            <input type="hidden" class="file-title" value="tipo-discos-fecha-">
            <h1 type="hidden" class="documento-title" style="display:none;">Tipo Discos, Fecha</h1>
            <div class="table-responsive">        
                <table id="tablaTipoDisco" class="table table-striped table-bordered table-condensed tabla-data" style="width:100%" >
...
<div class="modal fade" id="modalCRUD" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        ...
        <form id="formTipoDisco">    
            <div class="modal-body">
                <div class="form-group">
                <label for="nombre" class="col-form-label">Tipo disco:</label>
                <input type="text" class="form-control capitalize" id="tipoDisco" required>
                </div>
            </div>
