...
if ( $detect->isMobile() ) {
  ...
  echo "<div id='dWrapper' class='wrapper' style='width: 80%;float:right;'>";
    ...
    <div class="container">
        <header>
          <h1 class="mt-4"><b>Gestión tipo equipo</b></h1>
            <ol class="breadcrumb mb-4">
              <li class="breadcrumb-item"><a href="../../inicio/dashboard.php">Dashboard</a></li>
              <li class="breadcrumb-item active">Tipo equipo</li>
            </ol>
        </header> 
    </div>    
  ...
  background : #1a3c8a;
    ...
    <div class="container caja">
        <div class="row">
            ...
            <input type="hidden" class="file-title" value="tipo-equipos-fecha-">
            <h1 type="hidden" class="documento-title" style="display:none;">Tipo Equipos, Fecha</h1>
            <div class="table-responsive">        
                <table id="tablaTipoEquipo" class="table table-striped table-bordered table-condensed tabla-data" style="width:100%" >
