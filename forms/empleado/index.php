...
if ( $detect->isMobile() ) {
  ...
  echo "<div id='dWrapper' class='wrapper' style='width: 80%;float:right;'>";
    ...
    <div class="container">
        <header>
          <h1 class="mt-4"><b>Gestión de empleado</b></h1>
  ...
  background : #1a3c8a;
    ...
    <div class="container caja">
        <div class="row">
            ...
            <input type="hidden" class="file-title" value="control-empleados-fecha-">
            <h1 type="hidden" class="documento-title" style="display:none;">Control Empleados, Fecha</h1>
            <div class="table-responsive">        
                <table id="tablaEmpleado" class="table table-striped table-bordered table-condensed tabla-data" style="width:100%" >
            ...
            <form id="formEmpleadoC">    
                <div class="modal-body">
                                ...
                                <select class="form-control" name="select_Cargo" id="select_Cargo" required>
                                    <option value="">Seleccione..</option>
                                        <?php
                                            ...
                                            foreach($data as $dat) {     
                                                echo "<option value=".$dat["idCargo"]." class='form-control'>".$dat['cargo']."</option>";
                                            }
                                        ?>        
                                </select>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input minlength="" maxlength="" type="tel" class="form-control" id="celular" AUTOCOMPLETE="OFF">
                   ...
                   <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="nombre" class="col-form-label">Extensión:</label>
                                <input minlength="" maxlength="" type="tel" class="form-control" id="extension" AUTOCOMPLETE="OFF">
                                <span id="lblExtension"></span>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="select_Sexo" id="select_Sexo" required>
                                    <option value="">Seleccione..</option>
                                        <?php
                                            ...
                                            foreach($data as $dat) {     
                                                echo "<option value=".$dat["idSexo"]." class='form-control'>".$dat['sexo']."</option>";
                                            }
                                        ?>        
                                </select>
                            </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="nombre" class="col-form-label">Teléfono:</label>
                                <input type="tel" class="form-control" id="telefonoU" AUTOCOMPLETE="OFF">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="nombre" class="col-form-label">Celular:</label>
                                <input type="tel" class="form-control" id="celularU" AUTOCOMPLETE="OFF">
                            </div> 
                        </div>    
                    </div>    
                   ...
                   <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="nombre" class="col-form-label">Extensión:</label>
                                <input minlength="" maxlength="" type="tel" class="form-control" id="extensionU" AUTOCOMPLETE="OFF">
                                <span id="lblExtension"></span>
                            </div>
                        </div>
                        <div class="col-lg-6">
