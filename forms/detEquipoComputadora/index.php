...
if ( $detect->isMobile() ) {
  ...
  echo "<div id='dWrapper' class='wrapper' style='width: 80%;float:right;'>";
    ...
    <div class="container">
        <header>
          <h1 class="mt-4"><b>Gestión detalle equipo</b></h1>
  ...
  background : #1a3c8a;
    ...
    <div class="container caja">
        <div class="row">
            ...
            <h1 type="hidden" class="documento-title" style="display:none;">Detalle Equipos, Fecha</h1>
                                ...
                                <select class="form-control" name="select_CodEquipo" id="select_CodEquipo" required>
                                    <option value="">Seleccione..</option>
                                        <?php
                                            ...
                                            foreach($data as $dat) {     
                                                echo "<option value=".$dat["codEquipo"]." class='form-control'>".$dat['codEquipo']."</option>";
                                            }
                                        ?>        
                                </select>
                            </div>
