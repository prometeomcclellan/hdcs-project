...
<title>Estado control mantenimiento</title>
...
if ( $detect->isMobile() ) {
  ...
  echo "<div id='dWrapper' class='wrapper' style='width: 80%;float:right;'>";
    ...
    <div class="container">
        <header>
          <h1 class="mt-4"><b>Gestión de estado control mantenimiento</b></h1>
            <ol class="breadcrumb mb-4">
              <li class="breadcrumb-item"><a href="usuarioINDEX.php">Dashboard</a></li>
              <li class="breadcrumb-item active">Estado control mantenimiento</li>
            </ol>
        </header> 
    </div>    
    ...
    <br>  
    <style>
#tablaEstadoControlMantenimiento > thead {
  background : #1a3c8a;
}
</style>
    <div class="container caja">
        <div class="row">
            ...
            <div class="table-responsive">        
                <table id="tablaEstadoControlMantenimiento" class="table table-striped table-bordered table-condensed" style="width:100%" >
                    <thead class="text-center">
                        <tr>
                            <th>ID</th>
                            <th>Estado control mantenimiento</th>                   
                            <th>Acciones</th>
                        </tr>
                    </thead>
                    <tbody>                           
...
<div class="modal fade" id="modalCRUD" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        ...
        <form id="formEstadoControlMantenimiento">    
            <div class="modal-body">

                <div class="form-group">
                <label for="nombre" class="col-form-label">Estado control mantenimiento:</label>
                <input type="text" class="form-control capitalize" id="estadoControlMantenimiento" required>
                </div>
