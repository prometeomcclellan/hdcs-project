...
if ( $detect->isMobile() ) {
  ...
  echo "<div id='dWrapper' class='wrapper' style='width: 80%;float:right;'>";
    ...
    <div class="container">
        <header>
          <h1 class="mt-4"><b>Gestión de cargo</b></h1>
  ...
  background : #1a3c8a;
    ...
    <div class="container caja">
        <div class="row">
            ...
            <input type="hidden" class="file-title" value="control-cargos-fecha-">
            <h1 type="hidden" class="documento-title" style="display:none;">Control Cargos, Fecha</h1>
            <div class="table-responsive">        
                <table id="tablaCargos" class="table table-striped table-bordered table-condensed tabla-data" style="width:100%" >
                    <thead class="text-center">
                        <tr>
                            <th>ID</th>
                            <th>Cargo</th>     
                            <th class="last-col">Departamento</th>                
                            <!-- th>Acciones</th -->
                        </tr>
                    </thead>
                    <tbody>                           
            ...
            <form id="formCargosC">    
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control capitalize" id="cargo" required autofocus>
                    </div>

                    <div class="form-group">
                        <label for="nombre" class="col-form-label">Departamento:</label>

                        <select class="form-control" name="select_Depto" id="select_Depto" required>
        ...
        <div class="modal-content">
            ...
            <form id="formCargosU">    
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="nombre" class="col-form-label">Cargo:</label>
                        <input type="text" class="form-control capitalize" id="cargoU" required>
                    </div>

                    <div class="form-group">
                        <label for="nombre" class="col-form-label">Departamento:</label>

                        <select class="form-control" name="select_DeptoU" id="select_DeptoU" required>
                                <?php
                                    require_once '../../bd/conexion.php';
                                    $objeto = new Conexion();
                                    $conexion = $objeto->Conectar();
                                    ...
                                    foreach($data as $dat) {                                                        
                                ?>
                                       <option value="<?php echo $dat['idDepartamento']; ?>"> <?php echo $dat['departamento'] ?> </option>
                                <?php
                                    }
                                ?>  
                        </select>
