...
if ( $detect->isMobile() ) {
  ...
  echo "<div id='dWrapper' class='wrapper' style='width: 80%;float:right;'>";
    ...
    <div class="container">
        <header>
          <h1 class="mt-4"><b>Actualización de control mantenimiento </b></h1>
    ...
    <div class="container caja">
        <div class="row">
            ...
            <div class="table-responsive">        
                <table id="tablaControlMant" class="table table-striped table-bordered table-condensed" style="width:100%" >
            ...
            <form id="formControlMantU">    
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6" >
                            <button disabled id="btnBuscarU" type="button" class="btn btn-success" data-toggle="modal"><i class="material-icons" >search</i>  | Buscar</button>   
                        </div>    
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="fechaControlU" disabled="true" required >
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="select_TipoMantU" id="select_TipoMantU" disabled="true" required>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="select_UsuarioU" id="select_UsuarioU" disabled="true" required>
                            <option value="">Seleccione..</option>
                                <?php
                                    require_once '../../bd/conexion.php';
                                    $objeto = new Conexion();
...
<div class="modal fade" id="modalSolMant"  tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content" id="anchoModalBuscarSolMant">
            <div class="modal-header">
                <h5 class="modal-titles" id="exampleModalLabel"></h5>
                <button id="btnCloseUU" type="button" class="close" style="color:white;" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            </div>
