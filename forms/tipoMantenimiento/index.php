...
if ( $detect->isMobile() ) {
  ...
  echo "<div id='dWrapper' class='wrapper' style='width: 80%;float:right;'>";
    ...
    <div class="container">
        <header>
          <h1 class="mt-4"><b>Gestión tipo de mantenimiento</b></h1>
  ...
  background : #1a3c8a;
    ...
    <div class="container caja">
        <div class="row">
            ...
            <input type="hidden" class="file-title" value="tipo-mantenimiento-fecha-">
            <h1 type="hidden" class="documento-title" style="display:none;">Tipo Mantenimiento, Fecha</h1>
            <div class="table-responsive">        
                <table id="tablaTipoMantenimiento" class="table table-striped table-bordered table-condensed tabla-data" style="width:100%" >
