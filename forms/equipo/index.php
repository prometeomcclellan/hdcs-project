  ...
  background : #1a3c8a;
    ...
    <div class="container caja">
        ...
        <div class="row">
            ...
            <input type="hidden" class="file-title" value="control-equipos-fecha-">
            <h1 type="hidden" class="documento-title" style="display:none;">Control Equipos, Fecha</h1>
            ...
            <form id="formEquipoC">    
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="nombre" class="col-form-label">N° de inventario:<span class="requerido"> *</span></label>
                    ...
                    <div class="form-group">
                        <label for="nombre" class="col-form-label">Descripción:<span class="requerido"> *</span></label>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="nombre" class="col-form-label">Serie:<span class="requerido"> *</span></label>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content   update">
            ...
            <form id="formEquipoU">    
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-light" data-dismiss="modal">Cancelar</button>
                    <button type="submit" id="btnGuardarU" class="btn btn-dark" style="background-color: #1a3c8a;">Guardar</button>
                </div>
            </form>    
        </div>
    </div>
