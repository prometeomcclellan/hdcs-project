...
if ( $detect->isMobile() ) {
    ...
    echo "<div class='wrapper' style='width: 100%;float:right;'>";
}else{
  echo "<div class='wrapper' style='width: 80%;float:right;'>";
}
          ?>
    <div class="container">
        <header>
  ...
  background : #1a3c8a;
    ...
    <div class="container caja">
        <div class="row">
            ...
            <input type="hidden" class="file-title" value="control-capacidad-fecha-">
            <h1 type="hidden" class="documento-title" style="display:none;">Control Capacidad, Fecha</h1>
    ...
    <div class="modal-dialog" role="document">
        ...
        <form id="formCapacidad">    
            <div class="modal-body">
                ...
                <label for="nombre" class="col-form-label">Capacidad:<span class="requerido"> *</span></label>
                <input type="text" class="form-control capitalize" id="capacidad" required>
                </div>
            </div>
            <div class="modal-footer">
