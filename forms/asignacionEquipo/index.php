...
if ( $detect->isMobile() ) {
  ...
  echo "<li class='nav-item topnav-toggler'>";
}
          ?>
  ...
  background : #1a3c8a;
    ...
    <div class="container caja">
        <div class="row">
            ...
            <input type="hidden" class="file-title" value="asignación-equipos-fecha-">
            <h1 type="hidden" class="documento-title" style="display:none;">Asignación Equipos, Fecha</h1>
            <div class="table-responsive">        
                <table id="tablaAsignacionEquipo" class="table table-striped table-bordered table-condensed tabla-data" style="width:100%" >
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="nombre" class="col-form-label">Descripción equipo:</label>
                                <input type="textarea" class="form-control" id="descripcionEquipoU" disabled="true" required>
                            </div>
                        </div> 
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="nombre" class="col-form-label">Tipo equipo:</label>
                                <input type="text" class="form-control" id="tipoEquipoU" disabled="true" required>
                            </div>
                        </div>    
                    </div>  
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="nombre" class="col-form-label">Modelo equipo:</label>
                                <input type="text" class="form-control" id="modeloEquipoU" disabled="true" required>
                            </div>
                        </div> 
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="nombre" class="col-form-label">ServiceTag equipo:</label>
                                <input type="text" class="form-control" id="serviceTagEquipoU" disabled="true" required>
                            </div>
                        </div>    
                    </div> 
...
#tablaEquipo > thead {
  background : #1a3c8a;
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="table-responsive">        
                                    <table id="tablaEquipo" class="table table-striped table-bordered table-condensed tabla-data" style="width:100%" >
                                        <thead class="text-center">
                                            <tr>
                                                <th>Código equipo</th>
                                                <th>Tipo equipo</th>     
