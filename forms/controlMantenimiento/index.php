            ...
            <form id="formControlMantC">    
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <button id="btnBuscar" type="button" class="btn btn-success"  style="background-color: #1a3c8a;"
            ...
            <form id="formControlMantU">    
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <button id="btnBuscarU" type="button" class="btn btn-success"  style="background-color: #1a3c8a;"
                            data-toggle="modal"><i class="material-icons">search</i>  | Buscar</button>   
                        </div>    
                    </div>
