...
<title>Control Mantenimiento</title>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">            
                ...
                <!-- button id="dashboard_button" class="btn btn-warning">Dashboard</button -->
            </div>    
        </div>    
    </div>    
    <br>  
    <style>
#tablaControlMant > thead {
  background : #1a3c8a;
}
</style>
    <div class="container caja">
        <div class="row">
            ...
            <input type="hidden" class="file-title" value="control-mantenimiento-fecha-">
            <h1 type="hidden" class="documento-title" style="display:none;">Control Mantenimiento, Fecha</h1>
            <div class="table-responsive">        
                <table id="tablaControlMant" class="table table-striped table-bordered table-condensed tabla-data" style="width:100%" >
                    <thead class="text-center">
                        <tr>
                            <th>ID</th>
                            <th>Fecha control mantenimiento</th>     
                            <th>Código equipo</th>                
                            <th>Descripción equipo</th>
                            <th>Tipo mantenimiento</th>
                            <th>Id solicitud mant.</th>
...
<div class="modal fade" id="modalCREAR" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content  new" id="modalCuadro">
            ...
            <form id="formControlMantC">    
                <div class="modal-body">
                    <h5><b><i>Datos de la solicitud</i></b></h5> <hr>
                    <div class="row">
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                            <button id="btnBuscar" type="button" class="btn btn-success"  style="background-color: #ffc107;"
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="nombre" class="col-form-label">Falla:</label>
                                <input type="textarea" class="form-control" id="falla" disabled="true" required autofocus>
                            </div>
                        </div>    
                    </div>   
                    ...
                    <h5 id="h5"><b><i>Datos de control mantenimiento</i></b></h5> <hr>
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="select_TipoMant" id="select_TipoMant" required>
                                    <option value="">Seleccione..</option>
                                        <?php
                                            ...
                                            foreach($data as $dat) {     
                                                echo "<option value=".$dat["idTipoMantenimiento"]." class='form-control'>".$dat['tipoMantenimiento']."</option>";
                                            }
                                        ?>        
                                </select>
                            </div>
...
<div class="modal fade" id="modalUPDATE" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content  update" id="modalCuadro">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"></h5>
                <button type="button" class="close" style="color:white;" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span>
                </button>
            ...
            <form id="formControlMantU">    
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <button id="btnBuscarU" type="button" class="btn btn-success"  style="background-color: #ffc107;"
                            data-toggle="modal"><i class="material-icons">search</i>  | Buscar</button>   
                        </div>    
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="nombre" class="col-form-label">Falla:</label>
                                <input type="textarea" class="form-control" id="fallaU" disabled="true" required autofocus>
                            </div>
                        </div>    
                    </div>   
...
<div class="modal fade" id="modalSolMant"  tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
...
<!-- Modal BUSCAR Solicitud mantenimiento  UPDATE-->
<div class="modal fade" id="modalSolMant"  tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content" id="anchoModalBuscarSolMant">
            <div class="modal-header">
                <h5 class="modal-titles" id="exampleModalLabel"></h5>
                <button id="btnCloseU" type="button" class="close" style="color:white;" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            </div>
                <form id="formSolMantU">    
                    <div class="modal-body">
