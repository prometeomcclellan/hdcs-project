    ...
    $selectControlMant   = (isset($_POST['selectControlMant'])) ? $_POST['selectControlMant'] : ''; //3-finalizado  2-En reparación   1-Diagnosticado
        ...
        try {
            ...
            if ($selectControlMant === "3") {
                ...
                $mail->Body   = 'Estimado usuario '. "<b>".$nombre."</b>" . ", se ha registrado un nuevo control de mantenimiento a el equipo asignado a su nombre, equipo con código No. "."<b>".$codEquipo."</b>"."."." <br>" .
