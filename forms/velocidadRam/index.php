...
if ( $detect->isMobile() ) {
  ...
  echo "<div id='dWrapper' class='wrapper' style='width: 80%;float:right;'>";
    ...
    <div class="container">
        <header>
          <h1 class="mt-4"><b>Gestión de velocidad ram</b></h1>
            <ol class="breadcrumb mb-4">
              <li class="breadcrumb-item"><a href="../../inicio/dashboard.php">Dashboard</a></li>
              <li class="breadcrumb-item active">Velocidad ram</li>
            </ol>
        </header> 
    </div>    
  ...
  background : #1a3c8a;
    ...
    <div class="container caja">
        <div class="row">
            ...
            <input type="hidden" class="file-title" value="velocidad-ram-fecha-">
            <h1 type="hidden" class="documento-title" style="display:none;">Velocidad Ram, Fecha</h1>
            <div class="table-responsive">        
                <table id="tablaVelocidadRam" class="table table-striped table-bordered table-condensed tabla-data" style="width:100%" >
...
<div class="modal fade" id="modalCRUD" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        ...
        <form id="formVelocidadRam">    
            <div class="modal-body">
                <div class="form-group">
                <label for="nombre" class="col-form-label">Velocidad ram:</label>
                <input type="text" class="form-control capitalize" id="velocidadRam" required>
                </div>
            </div>
