...
if ( $detect->isMobile() ) {
  ...
  echo "<div id='dWrapper' class='wrapper' style='width: 80%;float:right;'>";
    ...
    <div class="container">
        <header>
          <h1 class="mt-4"><b>Gestión de modelo</b></h1>
  ...
  background : #1a3c8a;
    ...
    <div class="container caja">
        <div class="row">
            ...
            <input type="hidden" class="file-title" value="control-modelos-fecha-">
            <h1 type="hidden" class="documento-title" style="display:none;">Control Modelos, Fecha</h1>
            <div class="table-responsive">        
                <table id="tablaModelos" class="table table-striped table-bordered table-condensed tabla-data" style="width:100%" >
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="select_MarcaU" id="select_MarcaU" required>
                                <?php
                                    ...
                                    foreach($data as $dat) {                                                        
                                ?>
                                       <option value="<?php echo $dat['idMarca']; ?>"> <?php echo $dat['marca'] ?> </option>
                                <?php
                                    }
                                ?>  
                        </select>
