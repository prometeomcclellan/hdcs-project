...
if ( $detect->isMobile() ) {
  ...
  echo "<div id='dWrapper' class='wrapper' style='width: 80%;float:right;'>";
    ...
    <div class="container">
        <header>
          <h1 class="mt-4"><b>Gestión de departamento</b></h1>
    ...
    <div class="container caja">
        <div class="row">
            ...
            <div class="table-responsive">        
                <table id="tablaDepartamentos" class="table table-striped table-bordered table-condensed" style="width:100%" >
    ...
    <div class="modal-dialog" role="document">
        ...
        <form id="formDepartamentos">    
            <div class="modal-body">
                ...
                <input type="text" class="form-control capitalize" id="departamento" required>
                </div>
            </div>
