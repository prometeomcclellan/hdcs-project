...
if ( $detect->isMobile() ) {
  ...
  echo "<div id='dWrapper' class='wrapper' style='width: 80%;float:right;'>";
    ...
    <div class="container">
        <header>
          <h1 class="mt-4"><b>Gestión de marca</b></h1>
  ...
  background : #1a3c8a;
    ...
    <div class="container caja">
        <div class="row">
            ...
            <input type="hidden" class="file-title" value="control-marcas-fecha-">
            <h1 type="hidden" class="documento-title" style="display:none;">Control Marcas, Fecha</h1>
            <div class="table-responsive">        
                <table id="tablaMarcas" class="table table-striped table-bordered table-condensed tabla-data" style="width:100%" >
    ...
    <div class="modal-dialog" role="document">
        ...
        <form id="formMarcas">    
            <div class="modal-body">
                ...
                <input type="text" class="form-control capitalize" id="marca" required>
                </div>
